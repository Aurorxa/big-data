...
export const sharedConfig = withMermaid(defineConfig({
  ...
  vite: {
    ...
    plugins: [
      ...
      GitChangelog({
        // 填写在此处填写您的仓库链接
        repoURL: () => 'https://github.com/Aurorxa/big-data',
      }),
      GitChangelogMarkdownSection({
  ...
  sitemap: {
    hostname: `https://big-data.weiweixu.cn${VITE_BASE_URL}`,
  },
  ...
  themeConfig: { // 主题设置
    ...
    // 编辑链接
    editLink: {
      pattern: 'https://github.com/Aurorxa/big-data/edit/master/docs/:path',
      text: 'Edit this page on GitHub'
    },
    //社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Aurorxa/big-data' },
    ],
